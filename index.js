    ...
    init: function () {
        ...
        document.body.classList.add('body--ready');
			...
			if (ua.match(/MicroMessenger/i) == "micromessenger"||ua.match(/WeiBo/i) == "weibo"||ua.match(/QQ/i) == "qq"||ua.match(/AppleWebKit.*Mobile.*/)) {
				S.UI.simulate("小鬲|生日|快乐|啦~|欢迎|来到|22岁|#countdown 3|#rectangle 15x15|#circle 12 |#time");
            }
			else {
				S.UI.simulate("小鬲|生日快乐啦|要不止生日|欢迎来到22岁！！|#countdown 3|#rectangle 15x15|#circle 12 |#time");
			}
